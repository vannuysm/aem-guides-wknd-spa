package com.wyndham.baseapp.core.constants;
...
public interface WyndhamConstants {
    ...
    /**
     * Generic list constant
     */
    String GENERIC_LIST_PATH = "/etc/acs-commons/lists/";
    /**
    ...
    String CQ_TEMPLATE = NameConstants.NT_TEMPLATE;
...
//	String TAG_PREFIX_RESORT_BANNER = "wyndham:nextgen/resorts/banner/";
    ...
    // Template Paths
    String BLANK_NEXTGEN_TEMPLATE_PATH = "/conf/wyndham-nextgen/settings/wcm/templates/blank-page/initial/jcr:content";
    ...
    //stock ticker
      String STOCK_TICKER_URL = "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=ticker&interval=5min&apikey=3V1YPT1ML1D22246";
