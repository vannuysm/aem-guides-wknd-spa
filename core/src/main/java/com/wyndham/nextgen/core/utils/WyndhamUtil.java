...
import com.wyndham.nextgen.core.models.CFMResortModel;
            ...
            if (resource.getPath().contains("review")) {
                ...
                if (resortDetailResource != null) {
                    ...
                    if (valueMap != null) {
                        ...
                        CFMResortModel resortModel = resolver.getResource(contentSource + WyndhamConstants.CFM_MASTER_VARIATION_PATH).adaptTo(CFMResortModel.class);
